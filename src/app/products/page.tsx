    ...
    <div className="flex flex-col">
      ...
      <div className="p-4 md:p-8">
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-5 md:gap-4 mb-6 md:mb-8">
          ...
          <Card className="bg-emerald-50 border-emerald-200">
            ...
            <CardContent className="pt-0">
              ...
              <p className="text-xs md:text-sm text-emerald-700 mt-1 hidden md:block">EdgeOS + Fever</p>
            </CardContent>
          </Card>
        ...
        <div className="grid gap-4 md:gap-6 lg:grid-cols-3">
          ...
          {/* Products Table */}
          <Card className={feverMetrics && Object.keys(feverMetrics.revenueByPlan).length > 0 ? 'lg:col-span-1' : 'lg:col-span-2'}>
            <CardHeader className="pb-3 md:pb-6">
